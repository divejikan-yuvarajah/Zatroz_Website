...
**Current stage:** Desktop navigation (Step 15) on branch `feature/15-desktop-navigation`. Marketing pages are not built. No public deployment yet.
...
| Design system             | [`docs/design/design-system.md`](docs/design/design-system.md), [`contrast-checks.md`](docs/design/contrast-checks.md), [`ui-components.md`](docs/design/ui-components.md), [`form-components.md`](docs/design/form-components.md), [`navigation.md`](docs/design/navigation.md) |
...
| Desktop navigation                | Home wordmark in header; full bar on `/dev/ui` until other pages exist         |
