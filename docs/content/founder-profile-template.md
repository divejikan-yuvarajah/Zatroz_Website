...
Use one copy of this template per founder. There are **three** founders. Do not invent missing identities.

**Profile status:** `Missing` · `Draft` · `Needs review` · `Approved`
...
## Shared About-page checklist

- [ ] All three names approved for public use
- [ ] Roles do not overstate delivery capacity
- [ ] Portraits are consistent, non-stock, and consented
- [ ] No implied office size or headcount beyond reality
- [ ] Optional team photo uses the real team only
