...
**Public portfolio adapter:** Still repository-backed (`src/server/public-projects.ts`). MongoDB project documents are foundations for A09–A10 — not the live public source yet.
